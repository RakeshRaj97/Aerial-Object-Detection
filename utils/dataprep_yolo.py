...
if __name__ == '__main__':
    ...
    dota2darknet(os.path.join(filedir, 'train', 'images'),
                 os.path.join(filedir, 'train', 'labelTxt'),
                 os.path.join(filedir, 'train', 'labels'),
                 util.wordname_15)
    dota2darknet(os.path.join(filedir, 'val', 'images'),
                 os.path.join(filedir, 'val', 'labelTxt'),
                 os.path.join(filedir, 'val', 'labels'),
                 util.wordname_15)
