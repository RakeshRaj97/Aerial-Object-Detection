"""
Program to split the single large image to multiple smaller images
"""
import os
import codecs
import numpy as np
...
class splitbase():
    def __init__(self,
        ...
        self.thresh = thresh
        self.imagepath = os.path.join(self.basepath, 'newImages')
        self.labelpath = os.path.join(self.basepath, 'newlabelTxt')
...
if __name__ == '__main__':
    ...
    os.mkdir(os.path.join(filedir, 'yolo_data_reduced_classes'))
    os.mkdir(os.path.join(filedir, 'yolo_data_reduced_classes', 'train'))
    os.mkdir(os.path.join(filedir, 'yolo_data_reduced_classes', 'val'))
    split = splitbase(os.path.join(filedir, 'train'),
                      os.path.join(filedir, 'yolo_data_reduced_classes', 'train'),
                      gap=100,
                      subsize=512,
                      num_process=16
                      )
    ...
    split = splitbase(os.path.join(filedir, 'val'),
                      os.path.join(filedir, 'yolo_data_reduced_classes', 'val'),
                      gap=100,
                      subsize=512,
                      num_process=16
                      )
